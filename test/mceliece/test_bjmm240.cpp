...
TEST(BJMM, t240FullBaseList) {
	...
	static constexpr ConfigBJMM config(n, k, w, p, l, l1,
	                                   ...
	                                   l1, (l-l1),
	                                   w-4,
	                                   NUMBER_THREADS, false, false, true, 0);
	BJMM<config> bjmm(ee, ss, A);
...
TEST(BJMMD3, t240) {
	...
	constexpr static uint32_t l2 = 7;
