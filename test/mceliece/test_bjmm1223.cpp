...
// Small list instance
TEST(BJMM, t1223_small) {
	/*
  8.960001932068081, 15.920003864136161, 36.60032090750531
  {
    'time': 55.09040664276881,
    'memory': 15.948572560079928,
    'p1': 1,
    'l': 18,
    'l1': 2
  }
 */
	...
	static constexpr ConfigBJMM config(n, k, w, 1, 18, 2,
	                                   150, 3,
	                                   l1, l-l1,
	                                   w,
	                                   1);
