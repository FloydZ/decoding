...
#include "challenges/t120transformed.h"
...
TEST(MMT, t120) {
	constexpr uint32_t l = 22;
	constexpr uint32_t l1 = 10;
	constexpr uint32_t p = 3;
	constexpr uint32_t a = 24;

	static constexpr ConfigMMTTernary MMTconfig(n, k, w/2, p, l, l1, l1, l-l1, 10, 5, 4, 4, 2, k+l-a);
